...
function Home  () {
  ...
  return (
    ...
    <div className="  flex flex-wrap   " >
      ...
      {cat.length && cat?.map((catgory,i)=>{
        return <button key={i} className="p-3 m-5  h-[90px] w-[150px] border text-lg font-semibold  bg-white hover:shadow-blue-200 shadow shadow-black " onClick={()=>fillterData(catgory)}>{catgory}</button>
      })}
      </div>
    </div>
<div className=" flex flex-wrap   w-[95%] justify-center ">
        ...
        filterData.map((post)=>(
          <div key={post._id} className=" flex flex-wrap m-2 sm:w-[35vh] lg:w-[45vh] md:w-[50vh] ">
